...
<div class="personal-form">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="row">
                <!-- <div class="col-md-4">
                    <?= $form->field($modelStaff, 'id_personal')->widget(Select2::class, [
                        'data' => $personalName,
                ...
                <div class="col-md-4">
                    <?= $form->field($modelStaff, 'staff_category')->widget(Select2::class, [
                ...
                <div class="col-md-4">
                    <?= $form->field($modelStaff, 'staff_status')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-md-4">
                    <?= $form->field($modelStaff, 'department')->textInput(['maxlength' => true]) ?>
                </div>
            </div>

            <div class="row">
                <div class="col-md-4">
                    <?= $form->field($modelStaff, 'start_date')->widget(
                        DatePicker::class,
                        [
                ...
                <div class="col-md-4">
                    <?= $form->field($modelStaff, 'salary')->textInput(['type' => 'number']) ?>
                </div>
            </div>
